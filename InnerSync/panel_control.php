...
<head>
    <title>InnerSync</title>

    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
    <meta name="description" content="InnerSync es una app para organizar tus actividades diarias, tareas y eventos. Te ayuda a gestionar tu agenda, mejorar la productividad y equilibrar tus responsabilidades." />
        ...
        <div class="layout-inner">
            ...
            <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-white logo-dark">
                ...
                <div class="app-brand demo">
                    <span class="app-brand-logo demo">
                        <img src="assets/img/logo1.png" alt="Brand Logo" class="img-fluid">
                    </span>
                    <a href="panel_control.php.html" class="app-brand-text demo sidenav-text font-weight-normal ml-2">InnerSync  </a>
                ...
                <ul class="sidenav-inner py-1">
                    ...
                    <li class="sidenav-item active">
                        <a href="panel_control.php" class="sidenav-link">
            ...
            <div class="layout-container">
                ...
                <nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-dark container-p-x" id="layout-navbar">
                    ...
                    <!-- Brand demo (see assets/css/demo/demo.css) -->
                    <a href="panel_control.php" class="navbar-brand app-brand demo d-lg-none py-0 mr-4">
                        <span class="app-brand-logo demo">
