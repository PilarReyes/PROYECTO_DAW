        ...
        <div class="row">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a id="seleccion_habitos-link" href="seleccion_habitos.php">Seleccionar Hábitos</a></li>
                            <li><a id="crear-habito-link" href="crear_habito.php">Crear Hábito</a></li>
                            <li><a id="mis-habitos-link" href="mis_habitos.php">Mis hábitos</a></li>
                            <li><a id="historial-habitos-link" href="habitos_tracker.php">Historial de Hábitos</a></li>
                        </ul>
                    </li>
                    <li>
                        <button class="has-arrow" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a id="ver-estado-animo-link" href="mood_tracker.php">Estado de Ánimo</a></li>
                            <li><a id="historial-estado-animo-link" href="historial_mood.php">Historial de Estado de Ánimo</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
...
<div id="main-wrapper">
    ...
    <div class="col-md-6">
        <div class="content-body">
            <div class="container-fluid">
                <?php
                    if (!empty($subcat) && file_exists(__DIR__ . "/views/{$subcat}.php")) {
                    echo "Incluyendo archivo: " . __DIR__ . "/views/{$subcat}.php";
                    include(__DIR__ . "/views/{$subcat}.php");
                    } else {
                     echo "Incluyendo archivo: " . __DIR__ . "/views/calendario.php";
